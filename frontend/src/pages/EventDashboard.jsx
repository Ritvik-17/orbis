              ...
              <tbody>
                {filtered.length ? (
                  filtered.map((app) => (
                    <tr
                      key={app.id}
                      className="border-b hover:bg-gray-100 even:bg-gray-50 transition duration-200"
                    >
                      <td className="px-4 sm:px-6 py-3 sm:py-4 text-gray-500 text-xs font-mono truncate max-w-[120px]">
                        {app.userId}
                      </td>
          ...
          <tbody>
            {applications.map((app) => (
              ...
              >
                ...
                <td
                  className={`px-4 sm:px-6 py-3 sm:py-4 font-medium text-sm ${
                    app.status === "ACCEPTED"
                      ? "text-green-600"
                      : app.status === "PENDING"
                        ? "text-yellow-600"
    ...
    <>
      <div className="max-w-7xl mx-auto pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-3 max-w-2xl mx-auto text-base sm:text-xl text-gray-500 sm:mt-4">
            {event.tagline}
          </p>
        </div>
